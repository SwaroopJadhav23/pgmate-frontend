...
const RevenuePulseCard = ({stats, onNavigate}) => {
  ...
  return (
    <div
      className="dash-chart-card dash-revenue-card"
...
const BedHealthCard = ({stats, onNavigate}) => {
  ...
  return (
    <div
      className="dash-chart-card dash-bh-card"
        ...
        <div ref={managerLangRef} style={{position: "relative"}}>
          ...
          {managerLangOpen && (
            <div className="dash-lang-menu">
              <div className="dash-lang-header">Language</div>
              {[
                ...
                <div
                  ...
                  onClick={() => {
                    const cookieValue =
                      lang.value === "en" ? "/en/en" : `/en/${lang.value}`;
    ...
    >
      ...
      <div className="dashboard-welcome">
        <div className="welcome-text">
          <h2>
            Welcome back, <span className="welcome-name">Caretaker</span>
          </h2>
      ...
      <div className="mgr-quick-col">
        ...
        <div className="mgr-quick-row">
          <button
            className="mgr-quick-btn mgr-qb-purple"
          ...
          <button
            className="mgr-quick-btn mgr-qb-green"
            onClick={() => navigate("/manager/beds")}
          >
          ...
          <button
            className="mgr-quick-btn mgr-qb-orange"
            onClick={() => navigate("/manager/residents")}
          >
      ...
      <div className="mgr-overview-section">
        ...
        <div className="mgr-overview-grid">
          {overviewCards.map((card) => (
            <div
              key={card.label}
              className="mgr-overview-card"
              onClick={card.onClick}
            >
              <div
                className="mgr-overview-icon"
