        ...
        <div className="pv-printable" id="police-verification-printable">
          ...
          <div className="pv-page pv-page-1">
            ...
            <div className="pv-header-main">
              ...
              <div className="pv-photo-box">Photo</div>
            </div>
         ...
         {/* ===================== PAGE 2 — PG Rules and Regulations ===================== */}
          <div className="pv-page pv-page-2">
            ...
            <ol className="pv-rules-list">
              <li>Residents must follow all the rules and regulations of PG. Rules can be changed from time to time. A notice of at least <span className="pv-blue-bold">3 days</span> will be given for any changes in the rules. Violating the rules may result in legal action.</li>
              <li>Rent should be paid between 1st to 10th of every month. A late fee of ₹10 rupees per day will be charged after the 10th. If rent is not paid by the 20th, the room may be vacated without prior notice.</li>
              <li>Breakfast time: 1:00 AM to 1:15 PM. Lunch time: 1:15 PM to 3:00 PM. Dinner time: 7:15 PM to 9:00 PM. Please follow the timings strictly.</li>
              <li>Use of electrical appliances such as heater, water heater, iron, induction, mixer, electric kettle, etc. is strictly prohibited. A fine of ₹500 will be charged for first-time violation and ₹1000 for repeated violations. Use of AC / Cooler is allowed, but the temperature must be kept between 16°C to 24°C. A fine of ₹500 will be charged for not following this rule.</li>
              <li>Guests are not allowed. If any guest (for 30 minutes) is found inside the PG, the membership will be <span className="pv-blue-bold">cancelled</span> and the <span className="pv-blue-bold">security deposit will be forfeited</span>.</li>
              <li><span className="pv-blue-bold">Commission agents (brokers) are not allowed.</span> If anyone is found involved in brokerage activities, their membership will be <span className="pv-blue-bold">cancelled</span> and 50% of the security deposit will be deducted.</li>
              <li>Any type of addiction such as smoking, tobacco, gutkha, alcohol, etc. is strictly prohibited inside the PG. Those found doing so will be fined ₹1000 and membership will be cancelled.</li>
              <li>Keep your room, common areas, washrooms, and the entire PG premises clean. Do not throw garbage here and there. If anyone is found doing so, a fine of ₹500 will be charged.</li>
              <li>You are responsible for your own belongings. PG is <span className="pv-blue-bold">not responsible</span> for any loss or theft. If any loss occurs, inform the administrator immediately.</li>
              <li>Security deposit will be refunded within 7 to 15 working days after checkout and after adjusting any pending dues. If any damage is found, an amount of up to ₹500 may be deducted from the deposit.</li>
              <li>Keep locks on your room door. PGs are <span className="pv-blue-bold">not responsible</span> for any loss or theft.</li>
              <li>Entry is allowed till 1:30 AM. After that, <span className="pv-blue-bold">coordinator's permission</span> is mandatory. PG has full rights to deny entry.</li>
              <li>Please keep your mobile on <span className="pv-blue-bold">silent mode</span> in the PG. Do not make noise while talking on the phone.</li>
              <li>Do not spit, litter or throw waste outside the room, in corridors, near staircase, or in the parking area. It is <span className="pv-blue-bold">strictly prohibited</span>.</li>
              <li>Keep the water tank, washbasin, taps, fans, lights, and all PG facilities clean and in good condition. For any damage, you may be fined up to ₹500.</li>
              <li>Washing machine is available for use. For coordinator / owner's clothes, washing charge is ₹50 per wash.</li>
            </ol>
